...
syn region kmonaddefaliasBrackVal end=')' matchgroup=kmonaddefaliasMod start='(\zssticky-key)\?' nextgroup=kmonadNumber contained contains=kmonadAliascode,kmonaddefaliasBrackVal,kmonadNumber
